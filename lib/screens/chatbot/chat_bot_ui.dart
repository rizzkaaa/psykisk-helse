...
import 'package:uas_project/screens/chatbot/chat_bubble.dart';
import 'package:uas_project/screens/chatbot/typing_indicator.dart';
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                const Icon(Icons.psychology, color: Color(0xFFacc990), size: 40)
                    .animate(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ChatBubble(message: msg["content"] ?? "", isUser: isUser)
                    .animate()
